...
namespace Platform\Common\ErrorDetails\V1\Help;
 ...
 *
 * Generated from protobuf message <code>platform.common.error_details.v1.Help.Link</code>
 */
...
class_alias(Link::class, \Platform\Common\ErrorDetails\V1\Help_Link::class);
